# Architecture dossier templates

Copy this folder to start an architecture dossier for **any** initiative. View files **01–19** are empty fill-in skeletons. **[20-appendix.md](20-appendix.md)** explains modeling terms (ADR, C4, RACI, …). Product-specific names belong on [00-index.md](00-index.md), not on every view.
